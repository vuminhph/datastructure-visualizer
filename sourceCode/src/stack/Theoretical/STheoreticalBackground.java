...
public class STheoreticalBackground extends StackPane{
	...
	public STheoreticalBackground() {
    	...
    	for(int i = 1; i <= sceneCount; i++) {
    		...
    		final ObjectProperty<Image> poster = new SimpleObjectProperty<Image>(new Image("/stack/slides/Scene"+i+".png"));  

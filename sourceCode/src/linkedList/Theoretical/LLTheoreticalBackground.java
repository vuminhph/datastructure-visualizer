package linkedList.Theoretical;
...
public class LLTheoreticalBackground extends StackPane{
	...
	public LLTheoreticalBackground() {
		super();
    	...
    	for(int i = 1; i <= sceneCount; i++) {
    		...
    		final ObjectProperty<Image> poster = new SimpleObjectProperty<Image>(new Image("/linkedList/slides/Scene"+i+".png"));  

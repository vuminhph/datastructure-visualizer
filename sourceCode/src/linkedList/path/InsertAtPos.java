...
//		this.getElements().add(new MoveTo(linkedListLayer.getWidth()/2 - 4.5* width,height * 2));
//		this.getElements().add(new LineTo(linkedListLayer.getWidth()/2 - 4.5*width + pos * width,height * 2));
//		this.getElements().add(new LineTo(linkedListLayer.getWidth()/2 - 4.5*width + pos * width,linkedListLayer.getHeight() / 2 - height/2));

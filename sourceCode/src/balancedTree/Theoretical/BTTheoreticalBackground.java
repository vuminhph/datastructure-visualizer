package balancedTree.Theoretical;
...
public class BTTheoreticalBackground extends StackPane{
	...
	public BTTheoreticalBackground() {
		super();
    	...
    	for(int i = 1; i <= sceneCount; i++) {
    		...
    		final ObjectProperty<Image> poster = new SimpleObjectProperty<Image>(new Image("/balancedTree/slides/Scene"+i+".png"));  
    	...
    	nextButton.setOnAction(new EventHandler<ActionEvent>(){
    		...
    		public void handle(ActionEvent event) {
    			if(sceneCollector.getSceneIndex() >= sceneCount - 1) {
    				...
    				KeyFrame kf = new KeyFrame(Duration.seconds(.25 ), kv);
